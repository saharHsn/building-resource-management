...
public class Response<TContent> {
    ...
    protected Response(int status, String message, TContent content) {
        //this.requestId = ((RequestContext) RequestContextHolder.currentRequestAttributes().getAttribute("requestContext", 0)).getCorrelationId();
        ...
        this.duration = Calendar.getInstance().getTimeInMillis() -
                ((RequestContext) RequestContextHolder.currentRequestAttributes().getAttribute("requestContext", 0)).getRequestTime();
    }
