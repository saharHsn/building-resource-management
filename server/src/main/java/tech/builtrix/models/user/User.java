...
public class User extends EntityBase<User> {
	...
	/*
	 * @DynamoDBAttribute private List<UserToken> tokens;
	 */
	@DynamoDBTypeConverted(converter = EnumConverter.class)
	...
	/*
	 * @Column(name = "failed_logins", nullable = false) private Byte failedLogin =
	 * 0;
	 * 
	 ...
	 * 
	 * @NotAudited private List<UserLogin> logins;
	 */
