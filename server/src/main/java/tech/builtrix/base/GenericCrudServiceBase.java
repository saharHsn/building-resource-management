...
public abstract class GenericCrudServiceBase<TModel extends EntityBase<TModel>, TRepository extends CrudRepository<TModel, String>>
		extends ServiceBase {
	...
	protected GenericCrudServiceBase(TRepository repository) {
		this.modelType = (Class<TModel>) ((ParameterizedType) getClass().getGenericSuperclass())
