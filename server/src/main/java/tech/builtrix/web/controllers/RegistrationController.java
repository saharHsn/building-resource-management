...
*/
    @NoSession
    @RequestMapping(value = "/registrationConfirm", method = RequestMethod.GET)
    public byte[] confirmRegistration(final HttpServletRequest request, @RequestParam("token") final String token) throws IOException, NotFoundException {
    ...
    public Response<Void> resendConfirmation(final HttpServletRequest request, @RequestParam("token") final String existingToken) throws NotFoundException {
