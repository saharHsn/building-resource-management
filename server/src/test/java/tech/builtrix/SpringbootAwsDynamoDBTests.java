...
import tech.builtrix.configuration.DynamoDBConfig;
...
*/
    ...
    private void createTable(String tableName) {
        dynamoDBConfig.getDynamoDB().createTable(Collections.singletonList(new AttributeDefinition("id", ScalarAttributeType.S)),
                tableName,
                Collections.singletonList(new KeySchemaElement("id", KeyType.HASH)),
                new ProvisionedThroughput(10L, 10L));
    }
    ...
    private void buildingTest() {
        ...
        fullAddress.setPostalAddress("floor 3, building no 16, Kaman st, Shahidi st, Vanak sq, Tehran, Iran");
        ...
        */User user = userTest();
        ...
        assertTrue("The building name is correct.", buildings.get(0).getName().equals(BUILDING_NAME));*/
    }
}
